...
public class BarChart2Renderer extends DataRenderer {

    public final static String TAG = BarChart2Renderer.class.getSimpleName();
    ...
    public BarChart2Renderer(BarDataProvider chart, ChartAnimator animator,
...
//                c.drawRect(buffer.buffer[j], buffer.buffer[j + 1], buffer.buffer[j + 2], buffer.buffer[j + 3], mRenderPaint);
                ...
                Log.i(TAG, "drawDataSet: buffer left = " + buffer.buffer[j] + ", right = " + buffer.buffer[j + 3]);
                drawBar(c, buffer.buffer[j], buffer.buffer[j + 1], buffer.buffer[j + 2], buffer.buffer[j + 3]);
            }
        } else {
...
//                        buffer.buffer[j + 3], mRenderPaint);
    ...
    protected void drawBar(Canvas c, float left, float top, float right, float bottom) {
        Log.d(TAG, "drawBar() called with: with = " + (right - left) + ",left = [" + left + "], top = [" + top + "], right = [" + right + "], bottom = [" + bottom + "]");
...
//        c.drawCircle(mBarRect.left, mViewPortHandler.contentTop() + mRadius, mRadius, mHighlightPaint);
    }
