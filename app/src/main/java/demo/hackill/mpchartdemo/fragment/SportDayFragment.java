...
public class SportDayFragment extends SportChartFragment {
    ...
    protected void updateLeftAxis(BarChart mChart) {
        ...
        mChart.setXAxisRenderer(new XAxisRendererSportBarChart(mChart.getViewPortHandler(), mChart.getXAxis(), mChart.getTransformer(YAxis.AxisDependency.LEFT), mChart));
    }
